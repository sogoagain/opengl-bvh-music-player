...
void  BVH::RenderFigure( const Joint * joint, const double * data, float scale )
{
	...
	if ( joint->children.size() == 0 ) {
		...
		if (!(joint->name).compare("LeftToeBase")) {
			glColor3ub(0, 255, 0);
			glutWireSphere(0.02, 10, 10);
			glColor3ub(255, 0, 0);
		}
		if (!(joint->name).compare("RightToeBase")) {
			glColor3ub(0, 255, 0);
			glutWireSphere(0.02, 10, 10);
			glColor3ub(255, 0, 0);
		}
		...
		if (!(joint->name).compare("LeftHandIndex1")) {
			glColor3ub(0, 255, 0);
			glutWireSphere(0.02, 10, 10);
			glColor3ub(255, 0, 0);
		}
		if (!(joint->name).compare("LThumb")) {
			glColor3ub(0, 255, 0);
			glutWireSphere(0.02, 10, 10);
			glColor3ub(255, 0, 0);
		}
		if (!(joint->name).compare("RightHandIndex1")) {
			glColor3ub(0, 255, 0);
			glutWireSphere(0.02, 10, 10);
			glColor3ub(255, 0, 0);
		}
		if (!(joint->name).compare("RThumb")) {
			glColor3ub(0, 255, 0);
			glutWireSphere(0.02, 10, 10);
			glColor3ub(255, 0, 0);
		}
